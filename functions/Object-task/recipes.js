    ...
    for(let i=1; i<=recipes.length; i++)
        {
           document.write(recipes[i].name + "<br>")
           document.write(recipes[i].ingredients + "<br>")
           document.write("Rating : "+ recipes[i].rating + "<br>")
           document.write(recipes[i].cuisine + "<br>")
           document.write("calories : " + recipes[i].caloriesPerServing + "<br>")
           document.write("Review Count : " + recipes[i].reviewCount + "<br>")
           document.write("<br>")
        }